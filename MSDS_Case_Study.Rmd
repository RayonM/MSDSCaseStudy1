...
(grep("Indie Pale Ales", beersNbreweries$Beer_Name))

df = which(grepl("Ale", beersNbreweries$Beer_Name))# Add border things or use ^ to get True "Ale" from the names.
df
beersNbreweries$Beer_Name[df]
